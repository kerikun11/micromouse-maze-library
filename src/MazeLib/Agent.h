...
namespace MazeLib {
  class Agent {
  public:
    Agent(const Vectors& goals) : searchAlgorithm(goals) {}
    ...
    */
    SearchAlgorithm::Status calcNextDirs() {
      return searchAlgorithm.calcNextDirs(state, curVec, curDir, nextDirs, nextDirCandidates, isPositionIdentifying, isForceBackToStart, isForceGoingToGoal, matchCount);
    }
